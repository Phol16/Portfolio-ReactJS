...
const AboutMe = () => {
  return (
    <div className="flex justify-center bg-sky-700 ">
      <section className="bg-neutral-800 sm:w-4/5 flex flex-col justify-evenly items-center py-20 px-2">
        <div className={`${style.topContainer} xl:3/12 lg:w-6/12 sm:w-9/12 leading-8 `}>
          <h1 className="text-sky-500 font-bold mb-3 text-xl 2xl:text-2xl" id='AboutMe'>About Me</h1>
        ...
        <div className={`${style.bottomContainer} flex sm:flex-row sm:w-9/12 sm:justify-between lg:justify-around`}>
          ...
          <section className='flex flex-col justify-around'>
            <div>
              <h1 className="text-sky-500 font-bold  mb-3 sm:text-base 2xl:text-xl sm:text-center">Training</h1>
            ...
            <div>
              <h1 className="text-sky-500 font-bold  mb-3 sm:text-base 2xl:text-xl sm:text-center">Skills</h1>
              <SkillsIcons/>
            </div>
          </section>
        </div>

  ...
  return (
    <div ref={ref} className='p-1 flex justify-center items-center py-5' id='Projects'>
      <div className='flex flex-col '>
        ...
        <motion.section animate={animation} className='flex flex-col gap-5 justify-center items-center self-center'>
          ...
          <ProjectsComponent title={'Protfolio'} source={'https://github.com/Phol16/Portfolio-ReactJS'} tools={'HTML : CSS : JS : ReactJS : TailwindCss : FramerMotion : react-intersection-observer : react-responsive-carousel '} redirect={'https://portfolio-phol.onrender.com/'} image={[portfolio0, portfolio1, portfolio2]} description={'The current site you are in is this project, it is just a simple portfolio which contains informations about me and the projects'} />

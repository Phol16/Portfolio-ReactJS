    ...
    <div className="p-1 flex justify-center items-center py-10">
      <div className="flex flex-col ">
        ...
        <section className="flex flex-col justify-center items-center self-center ">
          ...
          <ProjectsComponent title={'TheMazeGame'} redirect={'#'} image={[]} description={'A very simple maze game where you can select difficulty from easy to hard and the objective of the game is to make it to the finish line.'} />

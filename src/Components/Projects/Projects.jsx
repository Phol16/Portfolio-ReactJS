    ...
    <div className="p-1 flex justify-center items-center py-10" id='Projects'>
      <div className="flex flex-col ">
        ...
        <section className="flex flex-col justify-center items-center self-center ">
          ...
          <ProjectsComponent title={'Eatstagram'} tools ={'HTML : CSS : JS : ReactJS : ExpressJS : MongoDb : Cloudinary : Auth0 '} redirect={'https://proj6-fe.onrender.com/'} image={[eatstagram0,eatstagram1,eatstagram2]} description={'Eatstagram is a mobile view application where you can login into your account post or upload/publish photos of you favorite foods you can also view other user posts and can interact the photos, you can also follow other user profile.'} />
